      ...
      <div className={"max-w-container-max mx-auto px-margin-mobile md:px-gutter relative z-10"}>
        <div className={"mb-10 md:mb-16"}>
          ...
          <div className={"flex flex-col md:flex-row justify-between items-start md:items-end gap-8"}>
            <h2 className={"font-headline-lg text-4xl md:text-5xl lg:text-6xl font-black max-w-3xl leading-tight"}>
              Our Residential Construction <span className={"text-primary italic"}>Projects</span>
            </h2>
            <Link className={"group flex items-center gap-3 text-primary font-black text-base md:text-lg hover:gap-5 transition-all bg-white px-6 md:px-8 py-3.5 md:py-4 rounded-full shadow-md"} to={"/projects"}>
              Explore All
              <span className={"material-symbols-outlined"}>arrow_forward</span>
            </Link>
          </div>
                  ...
                  <CarouselItem className={"pl-0 md:pl-4 md:basis-1/2 lg:basis-1/3"} key={project.slug}>
                    <article className={"group/card relative h-[500px] rounded-[2.5rem] overflow-hidden border border-outline-variant/20 shadow-xl"}>
                      ...
                      <div className={"absolute bottom-6 left-6 right-6 backdrop-blur-xl bg-white/10 border border-white/20 p-8 rounded-3xl transform transition-all duration-500 group-hover/card:-translate-y-2"}>
                        ...
                        <h4 className={"font-black text-2xl text-white mb-4"}>{project.title}</h4>
    ...
    <section className={"pt-12 md:pt-16 pb-section-gap bg-surface relative overflow-visible"}>
      ...
      <div className={"max-w-container-max mx-auto px-margin-mobile md:px-gutter"}>
        <div className={"mb-16"}>
          ...
          <h2 className={"font-headline-lg text-4xl md:text-5xl lg:text-6xl font-black"}>Client Satisfaction <span className={"text-primary italic"}>Stories</span></h2>
        </div>
                  ...
                  <div className={"testimonial-slide bg-white rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row items-stretch border border-outline-variant/20"}>
                    ...
                    <div className={"w-full lg:w-2/5 p-8 md:p-10 lg:p-12 flex flex-col justify-center bg-surface-container-low/20 relative"}>
                      ...
                      <div className={"flex items-center gap-4 md:gap-5"}>
                        ...
                        <div>
                          <h5 className={"font-black text-xl md:text-2xl text-on-surface leading-tight"}>{item.name}</h5>
      ...
      <div className={"max-w-container-max mx-auto px-margin-mobile md:px-gutter"}>
        <div className={"grid lg:grid-cols-12 gap-8 md:gap-10 items-end mb-10 md:mb-14"}>
          <div className={"lg:col-span-8"}>
            <h2 className={"font-headline-lg text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight mb-4 md:mb-6 font-black"}>Why <span className={"text-primary italic"}>Santhi Builders</span>?</h2>
            <p className={"text-base sm:text-lg md:text-xl text-on-surface-variant font-medium max-w-2xl"}>Traditional integrity meeting modern engineering precision at every milestone.</p>
          </div>
        ...
        <div className={"grid md:grid-cols-3 gap-6 md:gap-8 lg:gap-10 relative z-20"}>
          {items.map((item) => (
            <div className={`card-interactive bg-white p-6 md:p-8 lg:p-10 rounded-[2rem] md:rounded-[2.5rem] border border-outline-variant/30 group shadow-xl transform ${item.className}`} key={item.title}>
              ...
              <h4 className={"font-black text-xl md:text-2xl mb-4 md:mb-5"}>{item.title}</h4>
              <p className={"text-on-surface-variant text-base md:text-lg leading-relaxed opacity-80"}>{item.body}</p>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <section className={"py-8 md:py-12 bg-white border-y border-outline-variant/10 relative overflow-hidden"}>
      ...
      <div className={"max-w-container-max mx-auto px-margin-mobile md:px-gutter text-center mb-5 md:mb-7 relative z-10"}>
        ...
        <h2 className={"font-headline-lg text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-on-surface leading-tight mb-2 md:mb-3"}>Brands That Build <span className={"text-primary italic"}>With Us</span></h2>
      ...
      <div className={"max-w-container-max mx-auto px-5 md:px-8 lg:px-12 relative z-10 text-white"}>
        <div className={"grid lg:grid-cols-12 gap-6 md:gap-8 lg:gap-10 items-center"}>
          <div className={"lg:col-span-8 text-center lg:text-left"}>
            ...
            <h2 className={"font-headline-lg text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4 md:mb-6 font-black leading-tight"}>Instant Precision <span className={"italic text-secondary-container"}>Estimator</span></h2>
            <p className={"text-base sm:text-lg md:text-xl opacity-90 max-w-2xl leading-relaxed mx-auto lg:mx-0"}>Get an accurate sq.ft estimate based on market rates, premium materials, and execution standards tailored for your project.</p>
      ...
      <div className={"max-w-4xl mx-auto px-margin-mobile md:px-gutter"}>
        <div className={"flex flex-col items-center gap-6 md:gap-8 mb-8 md:mb-12 text-center mx-auto max-w-3xl"}>
          <div className={"w-full"}>
            ...
            <p className={"text-xl text-on-surface-variant font-medium"}>Clear answers for your construction journey.</p>
          </div>
        </div>
